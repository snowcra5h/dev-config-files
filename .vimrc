...
nmap <C-i> <Plug>VimspectorStepOver
nmap <C-o> <Plug>VimspectorStepInto
nmap <C-p> <Plug>VimspectorStepOut
...
set shiftwidth=8        " How many columns of whitespace a “level of indentation” is worth
...
"build
nmap        <C-F6>    :!g++ % -ggdb -o $(basename -s .c %)<CR><CR>
